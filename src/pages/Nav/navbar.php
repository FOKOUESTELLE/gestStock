...
<div class="container-scroller">
   ...
   <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row mb-4">
     <div class="navbar-brand-wrapper d-flex justify-content-center">
       <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
         <a class="navbar-brand brand-Logo1" href="../../index.html"><img src="../../assets/images/Logo1.jpeg" alt="logo" class="img-fluid w-102 w-sm-50"></a>
         <!-- <a class="navbar-brand brand-Logo1" href="../../index.html"><img src="../../assets/images/Logo1.jpeg" alt="logo"/></a> -->
