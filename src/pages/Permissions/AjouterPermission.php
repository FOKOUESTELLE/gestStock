...
<!-- formulaire d'ajout -->
    <div class="container my-5">
        ...
        <h1 class="text-center text-bold">Ajouter une Permission</h1>
        <div class="card border-primary mb-4 rounded-3">
            <div class="card-header d-flex justify-content-between align-items-center bg-secondary-subtle text-success rounded-3">
                <h3 class="mb-0"><i class="typcn typcn-plus-outline menu-icon"></i> Ajouter une permission<i class="fas fa-plus-circle"></i></h3>             
            </div>
