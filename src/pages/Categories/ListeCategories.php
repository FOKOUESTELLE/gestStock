...
<div class="container my-5">
    <h1 class="text-center text-bold">Liste des Categories</h1>
    ...
    <div class="modal fade" id="addCategorieModal" tabindex="-1" aria-labelledby="addCategorieModalLabel" data-bs-backdrop="static" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow">
                <div class="modal-header bg-dark-subtle">
                    <h5 class="modal-title text-success" id="addStudentModalLabel"><i class="typcn typcn-plus m-lg-1"></i> Ajouter une categorie <i class="typcn typcn-plus-circle"></i></h5>
