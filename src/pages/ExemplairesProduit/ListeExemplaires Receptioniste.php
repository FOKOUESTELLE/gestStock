                        ...
                        <tbody id="productsList">
                         ...
                         <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning rounded btnEdit" id="<?= $row["id_exemplaire"] ?>" name="btnmod">
                                    <i class="typcn typcn-edit fs-3"></i>
                                </button>
                                <button class="btn btn-danger rounded btnDel" id="<?= $row["id_exemplaire"] ?>" name="btnsup">
