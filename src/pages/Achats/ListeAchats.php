...
<div class="container my-5">
    <h1 class="text-center text-bold">Liste des achats</h1>
    <div class="card border-primary mb-3 rounded-3">
        ...
        <h3 class="mb-0"><i class="typcn typcn-shopping-cart"></i> Achats</h3>
            <button class="btn btn-add btn-success rounded-5 shadow" data-bs-toggle="modal" data-bs-target="#addAchatModal">
            <i class="typcn typcn-plus"></i> Ajouter achat 
            </button>
        </div>
        ...
        <div class="card-body shadow">
            <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered rounded-3 align-middle mt-4">
                    ...
                    <tbody id="achatsList">
                        <tr>
                            <td colspan="6" class="text-center">Aucun achat disponible</td>
                        </tr>
                    </tbody>
                </table>
