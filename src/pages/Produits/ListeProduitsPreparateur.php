                ...
                <table class="table table-striped table-hover table-bordered rounded-3 align-middle mt-4">
                    <thead class="table-primary">
                        <tr class="text-center fw-bold">
                            ...
                            <th scope="col"> <i class="typcn typcn-tag menu-icon fs-3"></i> Prix unitaire de vente
                            <th scope="col"><i class="typcn typcn-tag menu-icon"></i> Total d'exemplaire
                            <th scope="col"> <i class="typcn typcn-tag menu-icon fs-3"></i> Prix Total de vente
                    ...
                    <form id="ajoutProduitForm" method = "post" action ="">
                        <div class="mb-3">
                           ...
                           <div class="mb-3">
                               ...
                               <i class="typcn typcn-tag menu-icon"></i>Prix unitaire de vente
                               </label>
