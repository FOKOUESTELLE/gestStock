...
<div class="container my-5">
    ...
    <div class="card border-primary mb-3 rounded-3">
        ...
        <h3 class="mb-0"><i class="typcn typcn-cube"></i> Produits</h3>
            ...
            <i class="typcn typcn-cube m-lg-1"></i> Ajouter Produit <i class="typcn typcn-cart m-1"></i> 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow">
                <div class="modal-header bg-dark-subtle">
                    <h5 class="modal-title text-success" id="addStudentModalLabel"><i class="fas fa-users fa-lg"></i> Ajouter un produit <i class="fas fa-plus-circle"></i></h5>
